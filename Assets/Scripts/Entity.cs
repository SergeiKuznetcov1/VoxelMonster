...
public class Entity : MonoBehaviour
{
    ...
    private Cube[] _cubes;
    public static int DetouchedCubesAmount { get; private set; }
    public static int TotalCubesAmount { get; private set; }
    ...
    private void Awake()
    {
        ...
        CollectCubes();
        RecalculateCubes();
        TotalCubesAmount = GetComponentsInChildren<Cube>().Length;
    }
